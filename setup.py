...
#
#     from hr_module import metadata
#
# However, when we do this, we also import `hr_module/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'hr_module_cli = hr_module.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'hr_module_gui = hr_module.gui:entry_point'
        # ]
    }
)
